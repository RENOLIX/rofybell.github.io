export const algeriaWilayas = [
  ...
  "31 - Oran", "32 - El Bayadh", "33 - Illizi", "34 - Bordj Badji Mokhtar", "35 - Boumerdes", "36 - El Tarf", "37 - Tindouf", "38 - Tissemsilt", "39 - El Oued", "40 - Khenchela",
  ...
  "51 - Ouled Djellal", "52 - Beni Abbes", "53 - In Salah", "54 - In Guezzam", "55 - Touggourt", "56 - Djanet", "57 - El M'Ghair", "58 - El Meniaa",
];
...
export const defaultShippingRates: ShippingRate[] = algeriaWilayas.map((wilaya) => ({
  wilaya,
  domicile: 500,
  bureau: 350,
}));
